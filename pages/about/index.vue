<template lang="pug">
  ...
  section.about
    h1.title
      img(src=`${cmnPath}txt_about.svg` alt="ABOUT")
    .inner
      .image-box
        picture.picture
          img(src=`${path}illust-about@2x.png` alt="")
      .text-box
        p.name: img(src=`${path}kenta-nakajima.svg` alt="KENTA NAKAJIMA")
        .name-box
          p.small-name 中島 健太
          p.bar |
          p.role UI Designer
        p.explain {{ description }}
</template>
